...
|技適認証番号|211-220207（Seeed XIAO BLE nRF52840）|
|ファームウェア|ZMKファームウェア|
|バッテリー持続期間|150mAhの場合、3〜4週間（利用状況により変化します）|
|バッテリー充電の入力|USB-C接続により充電。入力電圧：5V|
|ローラーボリューム|回転時のクリック感には個体差があります。|
...
3. 上面ネジを全て外し、上面ボディを外し、基板を取り出し、基板裏側が見える状態にしてください。
   - 底面ネジの取り外しはお勧めしません。底面ネジはスペーサーとの締め付けがうまくいかないケースが多く、上面ネジを外すことを推奨します。
<br>
...
<a id="sec-6-3"></a>
## 6.3 キースイッチの取付け
- スライドスイッチをOFFにして、上面ボディに基板を重ねて、別途ご用意頂いたキースイッチ（Kailh Choc V2）を取り付けてください。
  - 左手側：24個
  - 右手側：24個

<a id="sec-6-4"></a>
## 6.4 上面ボディの取り付け
- キースイッチを取り付けた上面ボディと底面ボディを合わせ、上面ネジを全て取り付けてください。
